...
//
// class PluginConfigurator(private val pluggableClass: Class<Pluggable>) : Configurator, MethodHandler {
//
//   /**
//    * key: 配置接口的方法名，value: 配置接口刚要
//    */
//   // private val configurationSchemas = sortedMapOf<String, ConfigurationSchema>()
//   private val configurationSchemas = sortedMapOf<String, DataSchema>()
//
//   /**
//    * key: 配置在应用端的蛇形下划线风格命名，value: 配置值
//    */
//   private val configurationValues = Values(configurationSchemas)
//
//   /**
...
//     val interfaceName = configurableInterface.name
//     allMethods.forEach {
